...
== Usage
  ...
  url = signer.sign('http://d604721fxaaqy9.cloudfront.net/horizon.jpg?large=yes&license=yes', :ending => Time.now + 1.day)
...
aws_cf_signer is distributed under the MIT License, copyright &copy; 2010 STL