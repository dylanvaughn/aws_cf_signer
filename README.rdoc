...
Signing code inspired by:

* http://stackoverflow.com/questions/2632457/create-signed-urls-for-cloudfront-with-ruby

== Usage

  signer = AwsCfSigner.new('/path/to/my/pk-12345.pem')

  # expiration date is required
  # See Example Canned Policy at above AWS doc link
  url = signer.sign('http://d604721fxaaqy9.cloudfront.net/horizon.jpg?large=yes&license=yes', :until => 'Sat, 14 Nov 2009 22:20:00 GMT')

  # You can also use a Time object
  url = signer.sign('http://d604721fxaaqy9.cloudfront.net/horizon.jpg?large=yes&license=yes', :until => Time.now + 1.day)
  ...
  url = signer.sign('http://d604721fxaaqy9.cloudfront.net/training/orientation.avi',
    :until    => 'Sat, 14 Nov 2009 22:20:00 GMT',
  ...
  url = signer.sign('http://d84l721fxaaqy9.cloudfront.net/downloads/pictures.tgz',
    ...
    :until    => 'Fri, 16 Oct 2009 06:31:56 GMT',
    :resource => 'http://*',
